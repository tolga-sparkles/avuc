...
const defaultMarkers: LiveMarker[] = [
  { id: "hatay", location: [36.2, 36.16] },
  { id: "gaziantep", location: [37.06, 37.38] },
  { id: "london", location: [51.51, -0.13] },
  { id: "berlin", location: [52.52, 13.4] },
